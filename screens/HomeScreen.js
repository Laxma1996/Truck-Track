...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: getResponsivePixels(60, 80, 100),
    paddingBottom: getResponsivePixels(40, 48, 64),
  ...
  subtitle: {
    ...
    maxWidth: getResponsiveValue('100%', '80%', '75%'),
  },
  content: {
    flex: 1,
    paddingHorizontal: getResponsivePixels(16, 20, 24),
    paddingVertical: getResponsivePixels(16, 20, 24),
    alignItems: 'center',
